...
(setq casey-todo-file "w:/adagio/code/todo.txt")
(setq casey-log-file "w:/adagio/code/log.txt")
...
(defun casey-big-fun-c-hook ()
  ...
  (defun casey-header-format ()
     ...
     (insert "   $Notice: (C) Copyright 2014 by Travis Shultz. All Rights Reserved. $\n")
     (insert "   ======================================================================== */\n")
     (insert "\n")
     (insert "#define ")
     (push-mark)
